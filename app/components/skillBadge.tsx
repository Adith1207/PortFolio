...
const gradientClasses: Record<string, string> = {
  ...
  python:
    "bg-gradient-to-r from-yellow-300/30 via-emerald-300/20 to-cyan-300/30",
  ...
  tailwind:
    "bg-gradient-to-r from-teal-400/30 via-cyan-400/20 to-emerald-400/30",
  ...
  flask:
    "bg-gradient-to-r from-violet-400/30 via-fuchsia-400/20 to-pink-400/30",
  ...
  pandas:
    "bg-gradient-to-r from-amber-400/30 via-lime-400/20 to-emerald-400/30",
  arduino: "bg-gradient-to-r from-teal-400/30 via-cyan-400/20 to-sky-400/30",
  matlab:
    "bg-gradient-to-r from-yellow-400/30 via-amber-400/20 to-orange-400/30",
...
export default function SkillBadge({
  ...
  const accentClass = accentClasses[accent] ?? "bg-cyan-400/60";
  const gradientClass =
    gradientClasses[gradient] ??
    "bg-gradient-to-r from-cyan-400/30 via-blue-400/20 to-fuchsia-400/30";
