...
export default function CosmicBackground() {
  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-gradient-to-b from-[#030014] via-[#06001c] to-[#000010]">
      ...
      {/* 🌕 Glowing Moon */}
      <div className="absolute top-40 right-32 w-[200px] h-[200px] sm:w-[260px] sm:h-[260px] rounded-full bg-gradient-to-b from-gray-100 via-gray-300 to-gray-700 shadow-[0_0_80px_40px_rgba(200,200,255,0.2)] border border-white/10 overflow-hidden">
        {/* subtle craters */}
